class APIs{
  ...
  static String submitBirthDayUrl = "https://api.paystack.co/charge/submit_birthday";
  static String submitAddressUrl = "https://api.paystack.co/charge/submit_address";
